function rest() {
    ...
    sessionStorage.setItem("backPrev","../Suggestions/Restaurants/Restaurant.html");
    switch (restaurant) {
        case "1":
            restaurant1();
            break;
...
function restaurant1() {
    ...
    document.getElementById("desc").innerHTML = "Rua Príncipe Real" + "<br>" + "Price for two: 20€" +
                                                "<br>" + "Kid-Friendly" +"<br>" + "Rating";
...
function restaurant2() {
    ...
    document.getElementById("desc").innerHTML = "Rua Duque Ávila" + "<br>" + "Price for two: 50€" +
                                                "<br>" + "Seaview" +"<br>" + "Rating";
...
function restaurant3() {
    ...
    document.getElementById("desc").innerHTML = "Praça da Alameda" + "<br>" + "Price for two: 15€" +
                                                "<br>" + "Kid-Friendly" +"<br>" + "Rating";
...
function restaurant4() {
    ...
    document.getElementById("desc").innerHTML = "Largo de Pinheiro" + "<br>" + "Price for two: 10€" +
                                                "<br>" + "Group meal" +"<br>" + "Rating";
...
function restaurant5() {
    ...
    document.getElementById("desc").innerHTML = "Praça 24 de Julho" + "<br>" + "Price for two: 25€" +
                                                "<br>" + "Kid-Friendly" +"<br>" + "Rating";
...
function restaurant6() {
    ...
    document.getElementById("desc").innerHTML = "Largo Conde Barão" + "<br>" + "Price for two: 20€" +
                                                "<br>" + "Group meal" +"<br>" + "Rating";
...
function restaurant7() {
    ...
    document.getElementById("desc").innerHTML = "Rua do Loreto" + "<br>" + "Price for two: 25€" +
                                                "<br>" + "Seaview" +"<br>" + "Rating";
...
function restaurant8() {
    ...
    document.getElementById("desc").innerHTML = "Avenida Visconde" + "<br>" + "Price for two: 35€" +
                                                "<br>" + "Group meal" +"<br>" + "Rating";
...
function restaurant9() {
    ...
    document.getElementById("desc").innerHTML = "Rua Rodrigues" + "<br>" + "Price for two: 20€" +
                                                "<br>" + "Group meal" +"<br>" + "Rating";
