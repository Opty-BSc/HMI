...
function timeLoad() {
    ...
    document.getElementById("time").innerHTML = (times.getHours() < 10 ? '0' : '') + times.getHours() + ":"
...
function videoDuration() {
    ...
    if  (sessionStorage.getItem("videoDuration") !== null
        && sessionStorage.getItem("secondsPassed") == 60 ) { 
...
function mapD() {
    if (sessionStorage.getItem("videoDuration") !== null)
        document.getElementById("mapD").href = "Maps/Course.html";
    else
