function shareR() {
    ...
    document.getElementById("desc").innerHTML = "<br>" + "<b>To: </b> " + to + "<br>" + "<b>From: </b> " + from +
                                                "<br>" + "<b>By: </b>"+ transport + "<br>" + "<b>At: </b>" + time;
    switch(transport) {
        case "Bus":
            document.getElementById("transportType").src = "Imagens/Bus.png";
            break;
        case "Airplane":
            document.getElementById("transportType").src = "Imagens/Plane.png";
            break;
        case "Train":
            document.getElementById("transportType").src = "Imagens/Train.svg";
            break;
        case "Subway":
            document.getElementById("transportType").src = "Imagens/Subway.png";
            break;
    }
}
