...
function transportType() {
    ...
    switch(transport) {
        case "Airplane": 
            document.getElementById("logo").src = "Imagens/Plane.png";
            setStops(pl_stop);
            break;
        case "Train":
            document.getElementById("logo").src = "Imagens/Train.svg";
            setStops(ts_stop);
            break;
        case "Subway":
            document.getElementById("logo").src = "Imagens/Subway.png";
            setStops(ts_stop);
            break;
        case "Bus":
            document.getElementById("logo").src = "Imagens/Bus.png";
            setStops(b_stop);
            break;
    }
}
...
function setStops(object) {
    ...
    for (i=start; i<start+8; i++) {
        ...
        document.getElementById("time"+ (i-start+1)).innerHTML = (times.getHours() < 10 ? '0' : '') + times.getHours() + ":" +
...
function directionsModal(id) {
    ...
    sessionStorage.setItem("backPrev","../Schedules/Catalog.html");
